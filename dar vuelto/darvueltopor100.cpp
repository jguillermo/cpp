...
double dupli=0.0,dupli2;
dupli2=cant;
cout<<"num2  "<<cant<<"  dupli  "<<dupli;
double  m[13]={200,100,50,20,10,5,2,1,0.5,0.2,0.1,0.05,0.01};
...
cout<<"\ndupli  "<<dupli<<"   dupli2   "<<dupli2<<"      con[12]  "<<con[12];
for(i=0,j=0;i<=4;i++){if(con[i]!=0){gotoxy(3,8+j);cout<<"Billetes de "<<m2[i]<<"  =  "<<con[i];j=j+2;}}
for(i=5,j=0;i<=12;i++){if(con[i]!=0){gotoxy(40,j+8);cout<<"Monedas de "<<m2[i]<<"  =  "<<con[i];j=j+2;}}
