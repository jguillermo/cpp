...
char opl; clrscr();
char *lugar;
double almcasa=0.0,almtienda=0.0,almdepa=0.0;
   cout<<"\n\tACTUALIZA  PRODUCTO";
                      cout<<"\n\t-------------------\n\n";
...
do{cout<<"\tLugar de almacen.....:   ";
                  ...
                  switch(opl){
                  case '1': almtienda=cancomprada;strcpy(lugar,"Tienda");nl=1;break;
                   case '2': almcasa=cancomprada;strcpy(lugar,"Casa");nl=1;break;
                   case '3': almdepa=cancomprada;strcpy(lugar,"Depa");nl=1;break;
						}
                }while(nl!=1);
...
cout<<"\n\tProducto Especifico..:   "<<aproducto.getproductoespecifico();
cout<<"\n\tUnidad...............:   "<<aproducto.getunidad();
cout<<"\n\tCantidad comprada por "<<aproducto.getunidad()<<"  :  "<<cancomprada;
...
aproducto.setprecio(precio,l);
 ...
 aproducto.setalmtienda(cancomprada);
 aproducto.setalmdepa(cancomprada);
 aproducto.setalmcasa(cancomprada);
...
numboleta,tipoboleta,almcasa,almtienda,almdepa);
char op2;
do{
   cout<<"\n\nDesea corregir Y/N";op2=getch();
...
//*****************************************************************************
void gestorproductosA::debusca(char *bu){
int q;
 producto uproducto;
