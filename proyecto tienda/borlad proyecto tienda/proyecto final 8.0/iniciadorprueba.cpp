...
void disfecha(producto pro,int i,int l,double precio);
...
//***********************************************************
void gestorproductosA::disfecha(producto pro,int i,int l,double precio){
cout<<"\n\n";


cout<<"\r\t\t\t\t   ";    cout<<precio;
cout<<"\r\t\t    ";       cout<<pro.getnumboleta(l);
cout<<"\r\t";           cout<<pro.gettipoboleta(l);
cout<<"\r";             cout<<"  "<<i<<" >";
                  ...
                  for (int i=0;i<objproductos.numproductos();i++)
                       {
                          la=objproductos.buscafecha(fc,i);
                           if(la!=-1)
                              { j++;
                               ulproducto=objproductos.getproducto(i);
double precio=objproductos.sumatotalboleta(ulproducto.gettipoboleta(la),ulproducto.getnumboleta(la));
                               disfecha(ulproducto,j,la,precio);
                               y=yact;ve=1;
                              }
                       }
 if(la=-1&&ve==0){cout<<"\n\n\nNO EXISTE EL ARCHIVO";}getch();
