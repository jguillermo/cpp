...
{char *codi; int tipo;
  do{  clrscr();   cout<<"\n\n\t\t\t\tBUSCA PRODUCTO \n";
    ...
    case '2':clrscr();     cout<<"\n\n\t\t\t\tBUSCA PRODUCTO \n";
                       cout<<"\t\t\t\t--------------\n\n";
    				do{cout<<"\n\n\n\tProducto Especifico..:   ";gets(codi);
                 if(strlen(codi)>60){cout<<"\t\t\aMaximo 60 cifras\n";}
                 }while( strlen(codi)>60);
                  tipo=2;
                 debusca(codi,tipo);
          break;
...
//*********************************************************************
void gestorproductosA::debusca(char *bu,int tipo){
int q;
 producto uproducto;
