...
double pre,double pre1,char *di,char *me,char *yea,double cancom,
...
cout<<"\n\nIngrese Opcion   :";
    op=getch();int n=0, nl=0;
     ...
     {case'1': do{cout<<"\tCodigo............:";gets(codigo);
      ...
      case'9':  cout<<"\tPrecio total en soles (Lima)...:";cin>>act[l].precio; break;
      case'a':  cout<<"\tPrecio sugerido.:";cin>>act[l].preciosugerido; break;

       case'8':  cout<<"\tCantidad comprada por "<<unidad<<" :";cin>>act[l].cancomprada; break;

       case'5':  do{cout<<"\tTipo de documento..:";
          ...
          case'6':  do{cout<<"\tNumero de Documento........:";gets(act[l].numboleta);
...
cout<<"\n\t[5].- Tipo de documento.....:   "<<act[l].tipoboleta<<endl;
cout<<"\n\t[6].- Numero de Documento...:   "<<act[l].numboleta<<endl;
cout<<"\n\t[7].- Fecha de compra.......:   ";
cout<<act[la].fechacompra.dia<<" / "<<act[l].fechacompra.mes;
cout<<" / "<<act[l].fechacompra.year<<"\n";
cout<<"\n\t[8].- Cantidad Comprada.....:   "<<act[l].cancomprada<<endl;
cout<<"\n\t[9].- Precio total en soles (Lima):   "<<act[l].precio<<endl;
if(act[l].cancomprada!=0){
cout<<"\n\t[-].- Precio unitario por "<<unidad<<"  ..:   "<<(act[l].precio/act[l].cancomprada)<<endl; }
cout<<"\n\t[A].- Precio de venta sugerido x "<<unidad<<"  ..:   "<<act[l].preciosugerido<<endl;
