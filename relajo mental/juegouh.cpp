      ...
      do{   clrscr();
           ...
           pintar(j,h,r);
                   do{        op=menu();
                                ...
                                if(j==-15){j=1;op=endgame(j);break;}
                                if(j==0){op=endgame(j);break;}
...
clrscr();
 ...
 gotoxy(5,2);cout<<"Hay "<<j<<" fichas";
 gotoxy(5,4);cout<<"puedes retirar maximo  "<<r<<" fichas   ";
  char imagen=15;
  cout<<"\n\n\n\n\n\n" ;
 int k=1;
for (int i=1;i<=j;i++)
...
{ int gg;
 ...
 int retiros(int jj){
  ...
  int op;
   //gotoxy(1,24);cout<<"Para continuar C            Para reiniciar  R";
  op=toupper(getch());
  return op;
 }
